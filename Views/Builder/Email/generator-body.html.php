...
?>
    ...
    <td style="<?php echo $style['recommender-col']; ?>">
        ...
        <?php if (!empty($recommender->getProperties()['itemName'])): ?>
            <h5 class="recommender-name"
                style="<?php echo $style['recommender-name']; ?>"><?php echo $recommender->getProperties()['itemName']; ?></h5>
        <?php endif; ?>
        <?php if (!empty($recommender->getProperties()['itemShortDescription'])): ?>
            <p class="recombe-short-description"
               style="<?php echo $style['recombe-short-description']; ?>"><?php echo $recommender->getProperties()['itemShortDescription']; ?></p>
        <?php endif; ?>
